...
class CppExecCall:
    ...
    def extract_info(
        ...
        video: str,
        output_json: str,
        detect_exec: str = "/home/xiaodai/Code/yolov11-tensorrt/examples/demo/build/exec_detect_video",
        detect_engine: str = "models/yolo11s_person_basketball_backboard_hoop_1920_1088_AIAnalysi1_without_nms_batch4.engine",
        conf: float = 0.5,
    ) -> None:
    ...
    def refine_ball(
        ...
        video: str,
        output_json: str,
        refine_exec: str = "/home/xiaodai/Code/yolov11-tensorrt/examples/demo/build/exec_yolo_refine",
        refine_engine: str = "models/yolo11s_detect_ball_640_640_20260617.engine",
    ) -> None:
...
if __name__ == "__main__":
    ...
    cpp_exec.extract_info(
        video="/home/xiaodai/Code/yolov11-tensorrt/1800_frames.mp4",
        output_json="detect.json",
        detect_exec="/home/xiaodai/Code/yolov11-tensorrt/examples/demo/build/exec_detect_video",
        detect_engine="/home/xiaodai/Code/yolov11-tensorrt/model/yolo11s_person_basketball_backboard_hoop_1920_1088_AIAnalysi1_without_nms_batch4.engine",
        conf=0.4,
    )
