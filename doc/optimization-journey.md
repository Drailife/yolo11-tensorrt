...
| 方案 | FPS | 每帧耗时 | 总耗时 | vs Python |
|------|------|------|------|------|
| Python Ultralytics (基准) | 74 | 13.5 ms | 223.0s | 1.0× |
| C++ 原始（CPU NMS） | 104 | 9.6 ms | — | 1.4× |
| C++ GPU 解码 | 552 | 1.81 ms | 56.5s | 7.5× |
| C++ 双 Stream（batch=1） | 893 | 1.12 ms | 44.7s | **12.1×** |
| C++ 双 Stream + Batch=2 | 1051 | 0.95 ms | 43.3s | **14.2×** |
| **C++ 双 Stream + Batch=4** 🏆 | **1240** | **0.81 ms** | **41.6s** | **16.8×** |
| C++ 双 Stream + Batch=8 | 1181 | 0.85 ms | 43.4s | 15.9× |
